...
A Codex **plugin marketplace** (`workflow-daily-work`). It ships three
...
```
.Codex-plugin/marketplace.json   the marketplace (lists the plugins)
...
- **Skills must stay harness-neutral (Codex + Antigravity).** Name *actions*,
